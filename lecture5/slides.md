...
* [EconML](https://github.com/microsoft/EconML) (CATE estimators)
...
* Data science is more than just predictions -- it's about **decision making**
* Associations vs. causal relations
* *Correlation does not imply causation*

* Causality allows to ask different types of questions
  * Focus on actions and their impact on outcomes
* Not better than ML, just yet another tool
...
\begin{figure}
  \centering
  \includegraphics[trim={0 0 0 0},clip,width = 0.9\textwidth]{./graphics/Ladder-1.png}
\end{figure}
...
\begin{figure}
  \centering
  \includegraphics[trim={0 0 0 0},clip,width = 0.5\textwidth]{./graphics/graph.png}
\end{figure}
...
:::: column
* The most powerful (and hardest) in causality
* World model / Data generating process
* Encodes assumptions/priors
...
:::: column
* A - age
* S - sodium intake (intervention)
* B - blood pressure (outcome)
::::

:::: column
\begin{figure}
  \centering
  \includegraphics[trim={0 0 0 0},clip,width = 0.8\textwidth]{./graphics/sodium_rct.png}
\end{figure}
::::
...
* What will happen to B if we change S?
* What would have happened to B for a specific individual if they increased/decreased their S?
* What treatment decreases B most effectively?
* What is the best treatment to reduce B in terms of cost to effect ratio?
::::
...
\begin{figure}
  \centering
  \includegraphics[trim={0 0 0 0},clip,width = 0.8\textwidth]{./graphics/sodium_tri.png}
\end{figure}
::::
...
Too many to discuss here -- we will learn common principles to understand all other.
...
\begin{figure}
  \centering
  \includegraphics[trim={0 0 0 0},clip,width = \textwidth]{./graphics/mse_pehe.pdf}
\end{figure}

## Error On Outcomes vs. Effects
* MSE tells how well we fit the outcomes $Y_t$ (e.g. separately)
* However, the priority is to predict accurate **effects** ($Y_1 - Y_0$ difference)
...
* Compare causal estimators
* Testing a new method
* Include some form of ground truth
* Should use causal metrics
* Simulated or mixed with RCTs
::::

:::

## Types Of Metrics in Benchmarks
...
* $\epsilon_{ATE}$
* $\epsilon_{PEHE}$
* Simulated outcomes/counterfactuals
* (it's unnatural to observe both outcomes!)
* Perfect for model benchmarking
::::
...
* Mixed with RCTs (proxy ground truth)
::::
...
* Causality allows to answer new types of questions
...
* Modelling
  ...
  * Predict ITEs and ATEs
  * Compute $\epsilon_{ATE}$ and $\epsilon_{PEHE}$ metrics
  * Compare estimators
